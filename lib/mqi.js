...
// TODO Possible a bug here, so for now I have set the max buffer size to 4MB
// The possible bug happens as follows:
// - When a get is happening it tries to double de buffer size until it succeeds
// - But if you have a message that is 2.5MB and the buffer size is 2.2MB it will
//   try to double its size, becoming 4.4MB and exceeding the maximum size of 4MB
//   resulting in an error 2010 (in a default sized queue)
